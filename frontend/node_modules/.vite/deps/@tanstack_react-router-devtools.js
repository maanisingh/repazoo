import {
  ...
  lazy,
  render
} from "./chunk-47VJXTWT.js";
import {
  useRouter,
  useRouterState
} from "./chunk-JA2R5SX3.js";
import "./chunk-LAJLSB4C.js";
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-QTY5ENM6.js"));
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (this.#Component) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-IYDOV6V7.js"));
